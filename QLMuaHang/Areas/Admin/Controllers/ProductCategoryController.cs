using PagedList;
using QLMuaHang.Models;
using QLMuaHang.Models.EF;
using System;
...
namespace QLMuaHang.Areas.Admin.Controllers
{
    public class ProductCategoryController : Controller
    {
        ...
        public ActionResult Add(ProductCategory model)
        {
            if (ModelState.IsValid)
            {
                ...
                model.Alias = QLMuaHang.Models.Common.Filter.FilterChar(model.Title);
